...
export default function ActiveOrdersSubTab({
  orders,
  searchQuery,
  setSearchQuery,
                    ...
                    <div style={{ position: "relative" }}>
                      ...
                      {isStatusFilterOpen && (
                        <>
                          ...
                          <div style={{ position: "absolute", top: "42px", left: 0, width: "100%", background: "#fff", border: "1px solid #e5e7eb", borderRadius: "8px", boxShadow: "0 10px 15px -3px rgba(0, 0, 0, 0.1)", zIndex: 110, overflow: "hidden" }}>
                            {["All", "Pending", "Confirmed", "Packed", "Shipped", "Out for Delivery", "Delivery Attempted", "RTO Initiated", "RTO Delivered"].map((opt) => (
                              <div
                                key={opt}
                                ...
                                <tr className={styles.desktopRow} style={{ borderBottom: '1px solid #f9fafb', cursor: 'pointer' }} onClick={() => setSelectedOrder(order)}>
                                    ...
                                    <td>
                                      <span style={{
                                        ...
                                        backgroundColor: getStatusBadgeStyle(order.returnRequest?.status || "Pending").bg,
                                        color: getStatusBadgeStyle(order.returnRequest?.status || "Pending").color
                                      }}>
